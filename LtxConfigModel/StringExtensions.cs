...
public static class StringExtensions
{
    ...
    public static string TabsToSpaces(this string str, int tabSize = 8)
    {
        if (tabSize <= 0)
    ...
    public static int LeftPadding(this string str)
    {
    ...
    public static int RightPadding(this string str)
    {
        if (string.IsNullOrEmpty(str))
            return 0;
    ...
    /// </summary>
    public static string SpacesToTabs(this string str, int tabSize = 4)
    {
        if (tabSize <= 0)
            throw new ArgumentOutOfRangeException(nameof(tabSize));
